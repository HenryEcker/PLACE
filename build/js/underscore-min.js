...
(function() {
        ...
        return function(r, e, u, i) {
            ...
            var o = !k(r) && m.keys(r),
                ...
                c = n > 0
                    ? 0
                    : a - 1;
            return arguments.length < 3 && (u = r[o
                    ? o[c]
                    : c], c += n),
            t(r, e, u, o, c, a)
        }
    ...
    m.shuffle = function(n) {
        for (var t, r = k(n)
            ? n
            : m.values(n), e = r.length, u = Array(e), i = 0; e > i; i++)
            t = m.random(0, i),
            t !== i && (u[i] = u[t]),
            u[t] = r[i];
        return u
    ...
    m.initial = function(n, t, r) {
        return l.call(n, 0, Math.max(0, n.length - (null == t || r
            ? 1
            : t)))
    },
    ...
    m.pick = function(n, t, r) {
        ...
        m.isFunction(t)
            ...
            : (u = S(arguments, !1, !1, 1), e = function(n, t, r) {
                return t in r
            },
            o = Object(o));
